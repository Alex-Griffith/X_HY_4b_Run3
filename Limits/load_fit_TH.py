...
systs = ["JES__up", "JES__down", "JER__up", "JER__down", "JMS__up", "JMS__down", "JMR__up", "JMR__down", "PileUp_Corr_up", "PileUp_Corr_down", "TriggerSF_up", "TriggerSF_down", "Pdfweight_up", "Pdfweight_down", "nominal"]
if args.type == "signal":
