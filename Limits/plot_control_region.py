...
mode = "1p1"
f_name=f"Templates/Templates_{mode}_all.root"
...
for region in regions:
    for year in years:
        ...
        h_BKGs_rebinned_projx_merged[region][year]["Net_QCDJets"] = h_data_rebinned_projx[region][year].Clone(f"netQCD_x_{region}_{year}")
        h_BKGs_rebinned_projx_merged[region][year]["Net_QCDJets"].Add(h_BKGs_rebinned_projx_merged[region][year]["MC_TTBarJets"], -1)
        h_BKGs_rebinned_projy_merged[region][year]["Net_QCDJets"] = h_data_rebinned_projy[region][year].Clone(f"netQCD_y_{region}_{year}")
