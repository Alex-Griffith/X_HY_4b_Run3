    ...
    def selection_compound(self, JME_syst = "nom"):
        ...
        if not (self.isData == 1):
            if self.year != "2024":
                AutoPU.AutoPU(self.analyzer, self.corr_year)
            if self.year != "2024":
                AutoPU.AutoPU(self.analyzer, "2023_Summer23") #No PU correction esixts for 2024 yet, using 2023 as a temperary solution
            genW    = Correction('genW',"cpp_modules/genW.cc",corrtype='corr')
            evalargs = {
                    "genWeight": "genWeight",
                    "lumi": f"{self.lumi}",
        ...
        #FatJet quality
        self.analyzer.Define("flag1p1_IDCut","flag1p1_SkimCut == 0 ? false : FatJet_jetId.at(0) >= 2 && FatJet_jetId.at(1) >= 2")
        ...
        self.analyzer.Define("flag2p1_FatJetIDCut","flag2p1_SkimCut == 0 ? false : FatJet_jetId[val2p1_idxJH] >= 2 ")
        ...
        self.analyzer.Define("flag2p1_YJetIDCut", " flag2p1_SkimCut == 0 ? false : Jet_jetId[val2p1_idxJY0] >= 2 && Jet_jetId[val2p1_idxJY1] >= 2")
...
#############################################################################################################################
    ...
    def selection_without_trigger_1p1(self, JME_syst = "nom"):
        ...
        #FatJet quality
        self.analyzer.Cut("IDCut","FatJet_jetId.at(0) >= 2 && FatJet_jetId.at(1) >= 2")
        self.register_weight("FatJetID")
...
####################################################################################################################
    ...
    def Nminus1_1p1_old(self, JME_syst, MC_weight, f): 
        ...
        self.analyzer.Cut("IDCut","FatJet_jetId.at(0) > 1 && FatJet_jetId.at(1) > 1")
    ...
    def selection_compound_debug(self, JME_syst = "nom"):
        ...
        #FatJet quality
        self.analyzer.Cut("flag1p1_IDCut"," FatJet_jetId[0] >= 2 && FatJet_jetId[1] >= 2")
