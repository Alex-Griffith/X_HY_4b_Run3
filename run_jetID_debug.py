...
columns = ["nFatJet","FatJet_eta", "FatJet_jetId_corr", "Jet_jetId_corr", "MY", "MX", "leadingFatJetPt","leadingFatJetPhi","leadingFatJetEta", "leadingFatJetMsoftdrop", "MassLeadingTwoFatJets", "MassHiggsCandidate", "PtHiggsCandidate", "EtaHiggsCandidate", "PhiHiggsCandidate", "MassYCandidate", "PtYCandidate", "EtaYCandidate", "PhiYCandidate", "MJJ", "MJY", "PNet_H", "PNet_Y", "weight.*",  "FatJet_pt_JER__up", "PileUp_Corr__nom", "PileUp_Corr__up", "PileUp_Corr__down", "Pileup_nTrueInt", "val1p1.*", "val2p1.*", "flag1p1.*", "flag2p1.*"]

#Running selection
ana = XHY4b_Analyzer(args.dataset, args.year, args.n_files, args.i_job)
#ana.jetID_debug(args.JME_syst)
ana.selection_1p1_debug(args.JME_syst)
