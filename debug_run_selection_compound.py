...
ana.selection_compound_debug(args.JME_syst)
#ana.eff_after_selection_compound()
#Saving snapshot and cutflow
file_basename = os.path.basename(args.dataset).removesuffix(".txt")
ana.output = args.JME_syst + "_debug_compound_1p1_tagged_selected_" + file_basename + f"_n-{args.n_files}_i-{args.i_job}.root"
